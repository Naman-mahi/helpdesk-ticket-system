...
?>;
                                                                ...
                                                                class="form-select rounded-pill" aria-label="Default select example" name="new_importance">
                                                                    <?php
...
if ($row['ticket_importance'] == $rowimportance['importance_id']) {
        ...
        ?>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <select style="height: 30px;width:120px ;text-align: center;margin: auto;display: grid;font-weight: bold " 
                                                                    class="rounded-pill" id="myselect" aria-label="Default select example" name="new_assign">
                                                                        <?php
...
?>
        ...
        ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="submit" style="height: 30px;width:100px;text-align: center;margin: auto;display: grid;color:#F2F2F2 ;font-weight: bold" 
                                                                name="update_ticket" <?php if ($row['ticket_assign'] == '6') {?> disabled <?php }?> 
                                                                class="btn btn-success btn-rounded btn-sm fw-bold rounded-pill " data-mdb-ripple-color="dark">ASSIGN
                                                                </button>
                                                        </form>
                                                        </td>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Intelcode 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
