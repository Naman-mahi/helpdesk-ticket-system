                                                    ...
                                                    <tr>
                                                        <form method="POST" action="" id="myselect">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="submit" style="height: 30px;width:100px;text-align: center;margin: auto;display: grid;color:#F2F2F2 ;font-weight: bold" name="update_ticket" class="btn btn-success btn-rounded btn-sm fw-bold rounded-pill " data-mdb-ripple-color="dark">ASSIGN
                                                                </button>
                                                        </form>
                                                        </td>
