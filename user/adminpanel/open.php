...
if ($row['ticket_importance'] == $rowimportance['importance_id']) {
        ...
        ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="submit" name="update_ticket1" style="height: 30px;width:100px ;color:#F2F2F2 ;font-weight: bold" class="btn btn-success btn-rounded btn-sm fw-bold rounded-pill" data-mdb-ripple-color="dark">UPDATE
                                                                </button>
                                                            </td>
