...
if (isset($_POST['update_password'])) {
  ...
  $admin_name = $_SESSION['admin_name'] = $row['user_name'];
  ...
  $changePassword = $con->query("UPDATE user,admin SET user_password = '$pass',user.user_name='$user_name',admin.admin_name='$user_name'

  WHERE user_id = '$admin_name'");
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            $findresult = mysqli_query($con, "select * from user where user_name = '$id'");
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php $_SESSION['admin_name'] ?></span>
                <?php if ($avtar == null) {
                  echo '<img src="../assets/img/undraw_profile.svg">';
                } else {
                  echo '<img src="images/' . $avtar . '" img-profile rounded-circle" style="height:32px;width:32px;border-radius:62px;">';
                } ?>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown" style="background-color:yellow;">
                  ...
                  <div class="card mb-4">
                    <div class="card-body text-center">
                      <?php if ($avtar == null) {
                        ...
                        echo '<img src="images/' . $avtar . '" style="height:100px;width:100px;border-radius:50%;">';
                      } ?>
                      <!-- <img src="/upload/<?php $avtar ?>" alt="avatar"
              class="rounded-circle img-fluid" style="width: 150px;"> -->
                      <h5 class="my-3"><?php $_SESSION['admin_name'] ?></h5>
                ...
                if (isset($_POST['update_profile'])) {
                  ...
                  if (empty($error)) {
                    if (move_uploaded_file($_FILES["avtar"]["tmp_name"], $target_file)) {
                      $sql = "update user, admin set user.avtar='$profileImageName',admin.avtar='$profileImageName' WHERE user_id = '$user_id'";
                    ...
                    <div class="card-body">
                      <form method="post" enctype='multipart/form-data' action="profile.php">
                        <div class="mb-3">
                          ...
                          <input type="text" name="user_name" value="<?php echo $username; ?>" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
