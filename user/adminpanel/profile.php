                    ...
                    <div class="card-body">
                      <form method="post" enctype='multipart/form-data' action="profile.php">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" name="newpassword" class="form-control" placeholder="Enter new passowrd" id="exampleInputPassword1" required>
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Confirm New Password</label>
                          <input type="password" name="confirmpassword" placeholder="Enter confirm passowrd" class="form-control" id="exampleInputPassword1" required>
                        </div>
